...
# Hexagon shared objects (e.g. dsp/.../libc++.so.1) must not become RPM AutoReq.
AutoReqProv:    no
...
%changelog
* Tue Jul 14 2026 Porter <porter@local> - 20260714-3
- Disable AutoReqProv for Hexagon DSP sonames (libc++.so.1)
